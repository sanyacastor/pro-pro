        ...
        <ArticleContainer>
          <Container>
            ...
            <Paragraph>
              ...
              Уолт Дисней с&nbsp;братом оборудовали свою Disney Brothers Cartoon
              Studio в&nbsp;небольшом деревянном гараже своего дяди. Легенда
              гласит, что и&nbsp;свой первый макинтош Стив Джобс со&nbsp;Стивом
              Возняком собрали в&nbsp;гараже. Youtube&nbsp;&mdash; такая&nbsp;же
              история, и&nbsp;это только известные истории на&nbsp;весь мир.
            </Paragraph>
            <Paragraph>
