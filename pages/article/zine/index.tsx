        ...
        <Container>
          ...
          <S.Section>
            ...
            <Paragraph>
              ...
              складывается и&nbsp;нумеруется вручную.
            </Paragraph>
            <Paragraph>
              Зин, который мы&nbsp;сделали, про Протвино&nbsp;&mdash; город,
              в&nbsp;котором мы&nbsp;родились и&nbsp;выросли, город, который
              сильно изменился за&nbsp;последние годы. У&nbsp;Протвино множество
              уникальных и&nbsp;самобытных аспектов: архитектурных, визуальных,
              исторических. Но&nbsp;с&nbsp;каждым годом они все меньше заметны,
              и&nbsp;мы&nbsp;все реже говорим о&nbsp;них.
            </Paragraph>
            <Paragraph>
              В&nbsp;нашем зине мы&nbsp;собрали основные факты про историю
              Протвино и&nbsp;его особенности. А&nbsp;ещё рассказали про места,
              которые пока еще можно посетить&nbsp;&mdash; подготовили маршрут
              для самостоятельной прогулки и&nbsp;взаимодействия с&nbsp;городом.
          ...
          <S.Section>
            ...
            <Paragraph>
              ...
              Питере и&nbsp;даже в&nbsp;Латвии. В&nbsp;декабре мы&nbsp;выпустили
              тираж в&nbsp;новом исполнении. Мы&nbsp;не&nbsp;меняли кардинально
              наполнение, еще раз проверили все факты, но&nbsp;добавили
              новогоднего настроения и&nbsp;розового цвета! Техпроцесс
              так&nbsp;же остался прежним, все по&nbsp;канонам самиздата:
              печатали на&nbsp;ризографе, резали и&nbsp;складывали руками.
            </Paragraph>
            <Paragraph>
              По&nbsp;итогу второй зин получился ярким, можно сказать,
              новогодним. Мы&nbsp;продавали его на&nbsp;предновогодней барахолке
              в&nbsp;Протвино, а&nbsp;часть отложили и&nbsp;теперь зин про
              Протвино можно купить в&nbsp;Москве в&nbsp;Книжном в&nbsp;Клубе.
            </Paragraph>
            <Paragraph>
