...
export default function Article() {
  return (
    <>
      <Head>
        <title>Про про | Что такое советский модернизм</title>
        ...
        <meta
          property="og:title"
          content="Про про | Что такое советский модернизм"
        />
        <meta
          property="og:description"
          content="Что такое советский модернизм на примере Протвино"
        />
        ...
        <ArticleContainer>
          <Container>
            ...
            <Paragraph>
              ...
              случилось в&nbsp;начале 1930-х годов, второй &mdash;
              в&nbsp;середине 1950‐х. Период с&nbsp;1955 по&nbsp;1991 год был
              выведен в&nbsp;отдельное архитектурное направление&nbsp;&mdash;{' '}
              <Accent>
              ...
              и&nbsp;строительстве&raquo;&nbsp;&mdash; это и&nbsp;принято
              считать переходом к&nbsp;модернизму.
            </Paragraph>
            <Figure>
              <Image
            ...
            <Paragraph>
              ...
              архитекторы начали создавать новую архитектуру&nbsp;&mdash;
              экономичную, удобную для каждого.
            </Paragraph>
            <Paragraph>
              Придумать &laquo;новый город&raquo; предстояло архитекторам,
              многие из&nbsp;которых только что выпустились из&nbsp;МАРХИ.
              Пережившие войну в&nbsp;детстве, все они стремились создать
              удобный для каждого город, эстетически устремленный
              в&nbsp;будущее.
            </Paragraph>
            <Paragraph>
            ...
            <Section>
              ...
              <SubSection>
                ...
                <Paragraph>
                  ...
                  пространства и&nbsp;выбору внешней формы, светлый цвет
                  фасадов, стен.
                </Paragraph>
                <SliderWrapper>
                  <Slider>
              ...
              <Paragraph>
                ...
                декоративность, в&nbsp;качестве украшающих элементов
                использовали монументальное искусство: мозаичные панно,
                барельефы, металлоконструкции и&nbsp;прочее.
              </Paragraph>
              <SliderWrapper>
                <Slider>
                  <SwiperSlide>
                  ...
                  <SwiperSlide>
                    <Figure>
                      ...
                      />
                      <Figcaption>
                        Металлическая скульптура на фасаде Детской школы
                        искусств «Три трубадура», автор Николай Станиславский,
                        г. Протвино
                      </Figcaption>
                    </Figure>
                  </SwiperSlide>
              ...
              <Paragraph>
                Изюминкой в&nbsp;облицовке фасадов зданий в&nbsp;Протвино
                является штукатурка шуба с&nbsp;вкраплением камней и&nbsp;слюды,
            ...
            <Section>
              ...
              <Paragraph>
                В&nbsp;нашей стране модернизм оставил, кроме масштабных
                объектов, так называемую архитектуру малых форм
                (МАФ)&nbsp;&mdash; павильоны летних кафе, магазины,
                танцплощадки, автобусные остановки, детские площадки,
                бензозаправки и&nbsp;даже вертолетные станции. В&nbsp;нашем
                городе это такие магазины как Русь, Юбилейный, Ока, Восход,
                Дружба, а&nbsp;также летняя танцплощадка.
              </Paragraph>
              ...
              <Paragraph>
                ...
                а&nbsp;также выработан определенный стиль, явление до&nbsp;сих
                пор недостаточно изучено и&nbsp;оценено. По&nbsp;сути весь наш
                город&nbsp;&mdash; это памятник эпохи и&nbsp;слепок
                архитектурной мысли того времени. Мы&nbsp;хотим привлечь
                внимание к&nbsp;красоте и&nbsp;показать ценность уникальных
                артефактов времени, в&nbsp;котором они создавались. Призываем
                обращать внимание на&nbsp;тонкости и&nbsp;мелочи, которым
                в&nbsp;то&nbsp;время уделяли внимание и&nbsp;из&nbsp;которых
                соткан город. Мы&nbsp;сами с&nbsp;каждым годом замечаем
                их&nbsp;все больше и&nbsp;больше и&nbsp;не&nbsp;перестаем
                удивляться.
              </Paragraph>
            </Section>
          </Container>
