        ...
        <PostGrid>
          ...
          <Container>
            ...
            <ParagraphWithBackground $mt={38}>
              <Paragraph $indent={2}>
                ...
                эти конструкции оперировали архитектурными категориями: массой,
            ...
            <Paragraph $mt={64}>
              ...
              элементов и&nbsp;использовал цветовые контрасты, добиваясь тем
              самым динамического равновесия и&nbsp;монументальности
          ...
          <Container>
            ...
            <Paragraph $mt={32} $indent={1}>
              ...
              это в&nbsp;том числе на&nbsp;примере архитектурных объектов,
              которые нас окружают. Вероятно, концепцией архитектонов в&nbsp;том
              числе вдохновлялись и&nbsp;авторы проекта поликлиники
              в&nbsp;Протвино. Архитектура поликлиники насыщена разными
              элементами, например, ребристым украшением при виде с&nbsp;улицы,
              свойственным модернизму, огромным крестом-кубом на&nbsp;фасаде
              и&nbsp;так далее. А&nbsp;если посмотреть на&nbsp;общий объем
              здания, прослеживается связь с&nbsp;архитектонами.
            </Paragraph>
            ...
            <Paragraph $mt={64}>
              ...
              крыло&nbsp;&mdash; взрослая поликлиника. Между собой они соединены
              проходом между лифтовыми холлами. Вход по&nbsp;парадной лестнице
              со&nbsp;2-го этажа к&nbsp;регистратурам, на&nbsp;первом
              этаже&nbsp;&mdash; аптека. Причем войти можно
              и&nbsp;с&nbsp;первого этажа и&nbsp;подняться на&nbsp;лифте
              на&nbsp;нужный, что удобно для женщин с&nbsp;колясками
              и&nbsp;пенсионеров.
            </Paragraph>
          ...
          <Container>
            ...
            <Paragraph $mt={32} $indent={1}>
              ...
              с&nbsp;добавлением крошки декоративного камня, за&nbsp;счет
              которого поверхность сверкает на&nbsp;солнце. Для цветовых
              акцентов выбран натуральный терракотовый цвет. Сочетание этих
              материалов и&nbsp;цветов первоначально задумано архитектором Д.И.
              Кориным при проектировании Протвино. Подобные решения
              мы&nbsp;можем видеть на&nbsp;других зданиях города: Музыкальная
              школа, теоретический корпус ИФВЭ, Дом Ученых, Школа
              &#8470;&nbsp;3&nbsp;и&nbsp;другие.
            </Paragraph>
