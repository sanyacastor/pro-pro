...
export default function Polyclinic() {
  return (
    <>
      <Head>
        <title>Про про | Поликлиника или архитектурный памятник</title>
        ...
        <meta
          property="og:title"
          content="Про про | Поликлиника или архитектурный памятник"
        />
        <meta
          property="og:description"
          content="«Говорящая архитектура» — что это такое?"
        />
        ...
        <ArticleContainer>
          <PostGrid>
            ...
            из родоначальников постмодернизма."
                ...
                и&nbsp;есть перемена вектора от&nbsp;самодостаточности
                модернизма к&nbsp;говорящей архитектуре.
              </Paragraph>
            </Container>
            <Container>
              <Paragraph $indent={2} $size={28} $mt={56}>
                Выражение
                <i>
                  <Accent> architecture parlante </Accent>
                </i>
              ...
              <Paragraph $mt={32}>
                ...
                архитектурной мысли и&nbsp;их&nbsp;истоки в&nbsp;искусстве.
                Первый пример: здание аптеки в&nbsp;типовом жилом микрорайоне
                Москвы Борисово. Тут само здание является собственной вывеской
                и&nbsp;превращается в&nbsp;архитектурный артефакт. Источником
                вдохновения для авторов аптеки служило творчество Казимира
                Малевича.
              </Paragraph>
            ...
            <Container>
              ...
              <Paragraph $mt={32} $indent={1}>
                Малевич создал беспредметное искусство. Он считал, что живопись
                самоценна, что форма и чистый цвет способны выразить духовное
                ощущение художника. И создав новое направление в живописи –
                супрематизм, он предложил новое восприятие формы.
              </Paragraph>
              <Paragraph $mt={32} $indent={1}>
                Супрематизм (от лат.supremus — превосходный) — на начальном
                этапе этот термин, восходивший к латинскому корню – «supremus»,
                означал доминирование, превосходство цвета над всеми остальными
                свойствами живописи. В основание художник положил три формы:
                квадрат, крест и круг. Из этих форм рождаются все отношения в
                супрематической композиции.
              </Paragraph>
              ...
              <ParagraphWithBackground $mt={38}>
                <Paragraph>
                  ...
                  из&nbsp;супрематических &laquo;блоков&raquo;, которые
                  врезались друг в&nbsp;друга под прямым углом.
                  Блоки&nbsp;&mdash; бруски, кубы, параллелепипеды, которые
                  в&nbsp;свою очередь, являлись объемными аналогами
                  супрематических фигур ‒ квадратов и&nbsp;прямоугольников.
                </Paragraph>
                <CirceSquareCross />
              </ParagraphWithBackground>
            </Container>
            ...
            <Container>
              ...
              <ParagraphWithBackground $mt={38}>
                <Paragraph $indent={2}>
                  ...
                  называл архитектоны &laquo;чистой архитектурой&raquo;, так как
                  эти конструкции оперировали архитектурными категориями:
                  массой, объемом, тектоникой, масштабом.
                </Paragraph>
                <SquareFigure />
              </ParagraphWithBackground>
              ...
              <Paragraph $mt={64}>
                В&nbsp;набросках Ильи Чашника (ученика Малевича), который
                работал над проектированием &laquo;чистой архитектуры&raquo;,
                фронтальные изображения архитектонов демонстрируют осмысление
                пространственных супрематических конструкций как полноценных
                архитектурных сооружений. Он&nbsp;варьировал пропорциональные
                соотношения элементов и&nbsp;использовал цветовые контрасты,
                добиваясь тем самым динамического равновесия
                и&nbsp;монументальности архитектурной конструкции.
              </Paragraph>
            </Container>
            ...
            <Container>
              ...
              <Paragraph $mt={32} $indent={1}>
                Скоро стало ясно, что архитекторы приняли эти идеи.
                Мы&nbsp;видим это в&nbsp;том числе на&nbsp;примере архитектурных
                объектов, которые нас окружают. Вероятно, концепцией
                архитектонов в&nbsp;том числе вдохновлялись и&nbsp;авторы
                проекта поликлиники в&nbsp;Протвино. Архитектура поликлиники
                насыщена разными элементами, например, ребристым украшением при
                виде с&nbsp;улицы, свойственным модернизму, огромным
                крестом-кубом на&nbsp;фасаде и&nbsp;так далее. А&nbsp;если
              ...
              <Paragraph $mt={64}>
                Сама поликлиника спроектирована очень удобно для посетителей:
                левое крыло&nbsp;&mdash; детская поликлиника, правое
                крыло&nbsp;&mdash; взрослая поликлиника. Между собой они
                соединены проходом между лифтовыми холлами. Вход
                по&nbsp;парадной лестнице со&nbsp;2-го этажа
                к&nbsp;регистратурам, на&nbsp;первом этаже&nbsp;&mdash; аптека.
                Причем войти можно и&nbsp;с&nbsp;первого этажа и&nbsp;подняться
                на&nbsp;лифте на&nbsp;нужный, что удобно для женщин
                с&nbsp;колясками и&nbsp;пенсионеров.
              </Paragraph>

              <Paragraph $mt={32}>
                Что в&nbsp;этом уникального, скажет читатель, например,
                в&nbsp;Зеленограде, тоже есть поликлиника с&nbsp;похожим
                замыслом:
              </Paragraph>
            </Container>
            ...
            <Container>
              ...
              <Paragraph $mt={32} $indent={1}>
                ...
                на&nbsp;Т-образном перекрестке. Центральная часть
                с&nbsp;ребристым декором, а&nbsp;по&nbsp;бокам окна
                двухэтаж-ного здания выполнены таким образом, что мы&nbsp;видим
              ...
              <Paragraph $mt={64} $indent={1}>
                Примечательно, что объем поликлиники вписан в&nbsp;единый
                ансамбль с&nbsp;рядом стоящими зданиями общежитий по&nbsp;улице
                Ленина. А&nbsp;с&nbsp;другой стороны своей плоской частью
                вписывается в&nbsp;параллель с&nbsp;главной пешеходной улицей
                города.
              </Paragraph>

              <Paragraph $mt={32} $indent={1}>
                Цвета поликлиники: белый кирпич и&nbsp;светлая каменная
                штукатурка с&nbsp;добавлением крошки декоративного камня,
                за&nbsp;счет которого поверхность сверкает на&nbsp;солнце. Для
                цветовых акцентов выбран натуральный терракотовый цвет.
                Сочетание этих материалов и&nbsp;цветов первоначально задумано
                архитектором Д.И. Кориным при проектировании Протвино. Подобные
                решения мы&nbsp;можем видеть на&nbsp;других зданиях города:
                Музыкальная школа, теоретический корпус ИФВЭ, Дом Ученых, Школа
                &#8470;&nbsp;3&nbsp;и&nbsp;другие.
              </Paragraph>

              <Paragraph $mt={32} $indent={1}>
                Что касается внутреннего убранства: как и&nbsp;во&nbsp;всем
                Протвино, использованы натуральные материалы&nbsp;&mdash;
              ...
              <PostImage $mt={64}>
                ...
                />
                <figcaption>
                  Лестничные марши рядом с лифтами, открытые пространства
                  напротив окон дневного света.
                </figcaption>
              </PostImage>
              <PostImage $mt={64}>
                <CldImage
                ...
                />
                <figcaption>
                  Переход между зданиями поликлиники и МСЧ-57
                </figcaption>
              </PostImage>
              <Paragraph $mt={64}>
            ...
            <Container>
              ...
              <Paragraph $mt={32} $indent={1}>
                ...
                момент покрашен в&nbsp;желто-коричневый цвет. Вместо двух
                вывесок&nbsp;&mdash; одна типовая синяя вывеска &laquo;Моя
                поликлиника&raquo;. Современные управленцы не&nbsp;видят
                архитектурной ценности исторических зданий. Как это влияет
                на&nbsp;изменение облика города, каждый сможет оценить сам,
